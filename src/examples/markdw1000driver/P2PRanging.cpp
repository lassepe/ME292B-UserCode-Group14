...
volatile P2PRanging::MessageTypes P2PRanging::expectedMsgId;
volatile bool P2PRanging::sentAck;
volatile bool P2PRanging::receivedAck;
bool P2PRanging::protocolFailed;
DW1000Time P2PRanging::timePollSent;
DW1000Time P2PRanging::timePollReceived;
DW1000Time P2PRanging::timePollAckSent;
DW1000Time P2PRanging::timePollAckReceived;
DW1000Time P2PRanging::timeRangeSent;
DW1000Time P2PRanging::timeRangeReceived;
DW1000Time P2PRanging::timeComputedRange;
uint8_t P2PRanging::data[P2PRanging::LEN_DATA];
uint32_t P2PRanging::lastActivityTime_ms;
uint32_t P2PRanging::resetPeriod_ms;
uint16_t P2PRanging::replyDelayTime_us;
...
P2PRanging::P2PRanging()
{
	...
	resetPeriod_ms = DEFAULT_RESET_PERIOD_MS ;
	// reply times (same on both sides for symm. ranging)
	replyDelayTime_us = DEFAULT_DELAY_TIME_US;
...
void P2PRanging::resetInactive(){
    expectedMsgId = POLL;//listen for this, if we don't know what else is going on.
    noteActivity();
    rangingReceiver();
}
...
void P2PRanging::transmitPollAck() {
    ...
    DW1000Time deltaTime = DW1000Time(replyDelayTime_us, DW1000Time::MICROSECONDS);
